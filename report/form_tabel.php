...
include "../asset_default/script_tabel.php"
?>
          ...
          <div class="x_content">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <div class="row">
                  <div class="col-sm-12">
                      <h1 class="font-15 display-4 text-center"> 
                        Nama Toko
                      </h1><br>
                      <h4 class="text-center">Jl. Terusan Candi Mendut 9B</h4>
                      <h4 class="text-center">0898322148</h4>
                      <hr>
                      <h3 class="text-center">Laporan Stock</h3>
                      <h4 class="text-center">Tanggal DD/MM/YYYY</h4>
                      ...
                      <h2 class="text-right">Rp 100.000.000</h2>
                      <br>
                      <br>
                      <h2 class="text-right mx-auto">
                        Tempat, DD/MM/YYYY <br>
                        Penanggung Jawab
                      </h2>
                      <br>
                      <br>
