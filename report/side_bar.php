            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu d-print-none">
                <div class="menu_section">
                    <ul class="nav side-menu">
                      <li><a  href="../sales_order/dashboard.php"><i class="fa fa-th-large"></i> Dashboard </a>
                      </li>
                      ...
                      <li><a><i class="fa fa-desktop"></i> Laporan <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="../sales_order/form_tabel.php">Pemasukan Stock</a></li>
                            <li><a href="#">Pengeluaran Stock</a></li>
                            <li><a href="#">Laporan Keuangan</a></li>
                            <li><a href="#">Laporan Penjualan</a></li>
                            <li><a href="#">Laporan Produk Terlaris</a></li>
                        </ul>
                      </li>
                      <li>
