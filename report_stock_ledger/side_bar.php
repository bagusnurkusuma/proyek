...
<!-- FullCalendar -->
<link href="../asset_design/vendors/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet">
<link href="../asset_design/vendors/fullcalendar/dist/fullcalendar.print.css" rel="stylesheet" media="print">
<!-- Datatables -->
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu d-print-none">
                <div class="menu_section">
                    <ul class="nav side-menu">
                      <li><a  href="../asset_default/dashboard.php"><i class="fa fa-th-large"></i> Dashboard </a>
                      </li>
                      <li><a><i class=" fa fa-user"></i> Administrator <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="../administrator/store_page.php">Store Profile</a></li>
                            <li><a href="#">Change Profile</a></li>
                            <li><a href="#">Register User</a></li>
                            <li><a href="#">Notifikasi</a></li>
                        </ul>
                      </li>
                      <li><a><i class="fa fa-file-text"></i> Master <span class="fa fa-chevron-down"></span> </a>
                        <ul class="nav child_menu">
                      ...
                      <li><a><i class="fa fa-money"></i> Proses Transaksi <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="../point_of_sales/form.php">Point Of Sales</a></li>
                            <li><a href="#">Pengadaan Barang</a></li>
                            <li><a href="#">Material Convertion</a></li>
                        </ul>
                      </li>
                      <li><a><i class="fa fa-file-text-o"></i> Data Operational <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="../laporan/laporan.php">Laporan Bulanan</a></li>
                        </ul>
                      </li>
                      <li><a><i class="fa fa-desktop"></i> Report <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="#">Point Of Sales Report</a></li>
                            <li><a href="#">Pengadaan Report</a></li>
                            <li><a href="#">Stock Ledger</a></li>
                            <li><a href="#">Material Convertion Report</a></li>
                            <li><a href="#">Cash Bank Ledger</a></li>
                        </ul>
                      </li>
                      <li><a><i class="fa fa-list"></i> List <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="#">List Transaksi</a></li>
                            <li><a href="#">List Pengadaan</a></li>
                            <li><a href="#">List Material Convertion</a></li>
                        </ul>
                      </li>
                      <li>
        ...
        <!-- top navigation -->
        <div class="top_nav fixed-top d-print-none">
          <div class="nav_menu">
    ...
    <script src="../asset_design/vendors/fullcalendar/dist/fullcalendar.min.js"></script>
    <!-- Datatables -->
